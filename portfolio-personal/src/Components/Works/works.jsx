...
import mutualApp from '../Works/Icons/logo-mutual.png'
  ...
  return (
    <section className={`works ${theme}`}>
        ...
        <span className="worksDesc">{t('worksDescription')}</span>
            ...
            <ImageWithTooltip imageUrl={mutualApp} title={t('mutualApp')} gitRepo="https://github.com/alanfrancoa/Mutual-17-Junio" webSite= "https://mutual-17-junio.vercel.app/auth/login" />
