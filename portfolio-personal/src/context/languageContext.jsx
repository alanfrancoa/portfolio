...
const translations = {
  ...
  htmlName: 'HTML',
  htmlDescription: 'Lenguaje de marcado para la estructura de páginas web.',
  javaName: 'Java',
  javaDescription: 'Lenguaje de programación orientado a objetos, usado en aplicaciones empresariales.',
  gitName: 'Git',
  gitDescription: 'Sistema de control de versiones distribuido.',
  javascriptName: 'JavaScript',
  javascriptDescription: 'Lenguaje de programación para la web, permite interactividad.',
  cssName: 'CSS',
  cssDescription: 'Lenguaje de estilos para diseño y presentación web.',
  nodejsName: 'Node.js',
  nodejsDescription: 'Entorno de ejecución para JavaScript en el servidor.',
  reactName: 'React',
  reactDescription: 'Librería para construir interfaces de usuario interactivas.',
  phpName: 'PHP',
  phpDescription: 'Lenguaje de programación para desarrollo web backend.',
  netName: '.NET',
  netDescription: 'Framework de Microsoft para aplicaciones multiplataforma.',
  sqlName: 'SQL',
  sqlDescription: 'Lenguaje para gestión y consulta de bases de datos.',
  pythonName: 'Python',
  pythonDescription: 'Lenguaje de programación versátil y fácil de aprender.',
  dockerName: 'Docker',
  dockerDescription: 'Plataforma para crear, desplegar y ejecutar contenedores.',
  closeButton: 'Cerrar',
  ...
  htmlName: 'HTML',
  htmlDescription: 'Markup language for structuring web pages.',
  javaName: 'Java',
  javaDescription: 'Object-oriented programming language used in enterprise applications.',
  gitName: 'Git',
  gitDescription: 'Distributed version control system.',
  javascriptName: 'JavaScript',
  javascriptDescription: 'Programming language for the web, enables interactivity.',
  cssName: 'CSS',
  cssDescription: 'Style language for web design and presentation.',
  nodejsName: 'Node.js',
  nodejsDescription: 'Runtime environment for JavaScript on the server.',
  reactName: 'React',
  reactDescription: 'Library for building interactive user interfaces.',
  phpName: 'PHP',
  phpDescription: 'Programming language for backend web development.',
  netName: '.NET',
  netDescription: 'Microsoft framework for cross-platform applications.',
  sqlName: 'SQL',
  sqlDescription: 'Language for managing and querying databases.',
  pythonName: 'Python',
  pythonDescription: 'Versatile and easy-to-learn programming language.',
  dockerName: 'Docker',
  dockerDescription: 'Platform for creating, deploying, and running containers.',
  closeButton: 'Close',
